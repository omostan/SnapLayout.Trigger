...
### Changed
- Replaced package icon (128x128 PNG) for better visual identification on NuGet.org
- Enhanced README.md with updated download badge for monitoring latest version and downloads on NuGet.org
